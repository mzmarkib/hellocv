					...
					<div class="col-md-8 mx-auto">
						...
						<div class="wrap-login100 py-5 px-4">
							<form class="login100-form validate-form flex-sb flex-w" method="POST" action="server/login.php">
								<h2 class=" pb-4 text-center">Account Login</h2>
								...
								<div class="container-login100-form-btn text-center">
									<button class="login100-form-btn mx-auto" type="submit">Login</button>
								</div>
								<p class="pt-3">Don't have any account yet? <a href="register.php"><u>Register</u></a></p>
